...
<html lang="en">
  <head>
    ...
    <title>Jamuan Alam Jatigede - Masjid Al Kamil Jatigede</title>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="paket-desa.css" />
  </head>
  <body>
    <!--Navigation Bar-->
    <nav>
    ...
    <section class="image1">
      <div class="left">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/6RiuQBoAKs8?si=7ax-FV0XlSuj7FWD"
      ...
      <div class="right">
        <a
          href="https://www.google.com/maps/dir/-6.832128,108.2195968/lokasi+desa+wisata+karedok/@-6.7975056,108.0816727,12z/data=!3m1!4b1!4m10!4m9!1m1!4e1!1m5!1m1!1s0x2e6f2dd998dc887d:0x2a3e421f520022e2!2m2!1d108.1023929!2d-6.8329106!3e9?entry=ttu&g_ep=EgoyMDI0MTIwMy4wIKXMDSoASAFQAw%3D%3D"
          style="text-decoration: none; color: inherit"
        >
          <div class="maps">
            <p>
              Jl. Sasak Karedok, Karedok, Kec. Jatigede, Kabupaten Sumedang,
              Jawa Barat 45377
            </p>
          </div>
        </a>
        <div class="daftar">
         <a href="index1.php" style="color: inherit; text-decoration: none;"><p"><span>Menyewa Saung</span></p></a> 
        </div>
        <div class="info">
          <p><span>Rp10.000</span></p>
        </div>
      </div>
    </section>
