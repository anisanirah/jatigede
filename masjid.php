...
<html lang="en">
  ...
  <body>
      ...
      <div class="text">
        <h3>
          <span
            ...
            "
          >
            Masjid Al Kamil yang terletak di kawasan wisata Bukit Panenjoan,
            Desa Jemah, Kecamatan Jatigede, Kabupaten Sumedang, Jawa Barat,
            telah menjadi ikon baru dan destinasi wisata religi yang populer.
            Masjid ini dirancang oleh Gubernur Jawa Barat, Ridwan Kamil, dengan
            bentuk yang unik menyerupai bunga teratai yang sedang mekar.
          </span>
        </h3>
      </div>
    </section>
    ...
    <section class="image1">
      <div class="left">
        <img src="/asset/masjid4.jpg" alt="" />
        <img src="/asset/masjid.jpg" alt="" />
      </div>
      <div class="right">
        <img src="/asset/masjid1.jpg" alt="" />
      </div>
    </section>
    <section class="garis">
      <div class="horizon1"></div>
    ...
    <section class="image2">
      <div class="left2">
        <img src="/asset/masjid6.jpg" alt="" />
        <img src="/asset/masjid2.jpg" alt="" />
      </div>
      <div class="right2">
        <img src="/asset/masjid3.jpg" alt="" />
      </div>
    </section>
    <br /><br /><br /><br />
    <section class="garis">
