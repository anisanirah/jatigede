...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="paket-masjid.css" />
  </head>
  <body>
    <!--Navigation Bar-->
    <nav>
    ...
    <section class="image1">
      <div class="left">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/tr3xF6Q839k?si=K92dpjI8Pl6gyhpd"
      ...
      <div class="right">
        <a
          href="https://www.google.com/search?sca_esv=a9b95fc3d4d04a29&sxsrf=ADLYWIKmif-TDuJ6-bYdlnSDtPHZWaWlWQ:1730649629651&kgmid=/g/11rhzwzhm9&q=Masjid+Al+Kamil+Jatigede&shndl=30&shem=uaasie&source=sh/x/loc/uni/m1/1&kgs=d0f6a28018d88936"
          style="text-decoration: none; color: inherit"
        >
          <div class="maps">
            <p>
              44HC+JXC, Jemah, Kec. Jatigede, Kabupaten Sumedang, Jawa Barat
              45377
            </p>
          </div>
        </a>
        <div class="daftar">
          <a href="index1.php" style="color: inherit; text-decoration: none;"><p><span>Tugu Kujang Kembar</span></p></a>
        </div>
        <div class="info">
          <p><span>Rp25.000 / orang</span></p>
        </div>
      </div>
    </section>
